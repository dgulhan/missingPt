...
void ntupler_test(double ptmin_trk=0.5,double ptmax_trk=100){ 
 TH1D::SetDefaultSumw2();
 TString algo="akPu3Calo"; 
 ...
 for(int ipt=0; ipt<npt;ipt++){
   if(ipt>=5)f_eff[ipt]= new TFile(Form("/afs/cern.ch/user/d/dgulhan/workDir/trackCorrection/%s/eff_pt%d_%d_cent%d_%d_step_cent3accept3pt3rmin2.root",algo.Data(),(int)ptmin[ipt],(int)ptmax[ipt],(int)(0.5*cent_min[ipt]),(int)(0.5*cent_max[ipt])));
   if(ipt<5)f_eff[ipt]= new TFile(Form("/afs/cern.ch/user/d/dgulhan/workDir/trackCorrection/%s/eff_pt%d_%d_cent%d_%d_step_cent4accept4pt4rmin3.root",algo.Data(),(int)ptmin[ipt],(int)ptmax[ipt],(int)(0.5*cent_min[ipt]),(int)(0.5*cent_max[ipt])));
 ...
 for(int ipt=0; ipt<npt;ipt++){
   f_fake[ipt]= new TFile(Form("/afs/cern.ch/user/d/dgulhan/workDir/trackFake/final_hists_%s/fake_pt%d_%d_cent%d_%d_step_cent4accept4pt4rmin3_%s_dogenjet0.root",algo.Data(),(int)ptmin[ipt],(int)ptmax[ipt],cent_min[ipt],cent_max[ipt],algo.Data()));
 ...
 TFile *outf= new TFile(Form("ntuples_test/full_ntuple_%s_pt%d_%d_%s.root",infname.Data(),(int)ptmin_trk,(int)ptmax_trk,algo.Data()),"recreate");
 ...
 std:string jetVars="cent:pt1:eta1:phi1:pt1_boosted:eta1_boosted:phi1_boosted:pt2:eta2:phi2:pt2_boosted:eta2_boosted:phi2_boosted:pt3:eta3:phi3:pt3_boosted:eta3_boosted:phi3_boosted:dphi:ptratio:jetspz:jetspt:jetseta:jetsrap:jetsphi:jetspz_12:jetspt_12:jetseta_12:jetsrap_12:jetsphi_12:trkrap:mpt:mpt_boosted:mp:mp_boosted:mpt_s:mpt_boosted_s:mp_s:mp_boosted_s:mpt_b:mpt_boosted_b:mp_b:mp_boosted_b:mpt_tracks:mpt_boosted_tracks:mp_tracks:mp_boosted_tracks:mpt_parts:mpt_boosted_parts:mp_parts:mp_boosted_parts:mpt_tracks_uncorr:mpt_boosted_tracks_uncorr:mp_tracks_uncorr:mp_boosted_tracks_uncorr:hfp:hfm:Npassingtrk";
 ...
 TNtuple *nt_mpt_boosted_parts=new TNtuple("nt_mpt_boosted_parts","",mptVars.data());
 TNtuple *nt_mp_parts=new TNtuple("nt_mp_parts","",mptVars.data());
 TNtuple *nt_mp_boosted_parts=new TNtuple("nt_mp_boosted_parts","",mptVars.data());
 ...
 std::string mptVars_dR="dR_0:dR_1:dR_2:dR_3:dR_4:dR_5:dR_6:dR_7:dR_8:dR_9:dR_10:dR_11:dR_12:dR_13:dR_14:dR_15:dR_16:dR_17:dR_18:dR_19";
 
 TNtuple *nt_mpt_parts_dR=new TNtuple("nt_mpt_parts_dR","",mptVars.data());
 TNtuple *nt_mpt_boosted_parts_dR=new TNtuple("nt_mpt_boosted_parts_dR","",mptVars.data());
 TNtuple *nt_mp_parts_dR=new TNtuple("nt_mp_parts_dR","",mptVars.data());
 TNtuple *nt_mp_boosted_parts_dR=new TNtuple("nt_mp_boosted_parts_dR","",mptVars_dR.data());
 ...
 TNtuple *nt_mpt_s_dR=new TNtuple("nt_mpt_s_dR","",mptVars.data());
 TNtuple *nt_mpt_boosted_s_dR=new TNtuple("nt_mpt_boosted_s_dR","",mptVars.data());
 TNtuple *nt_mp_s_dR=new TNtuple("nt_mp_s_dR","",mptVars.data());
 TNtuple *nt_mp_boosted_s_dR=new TNtuple("nt_mp_boosted_s_dR","",mptVars_dR.data());
 
 TNtuple *nt_mpt_b_dR=new TNtuple("nt_mpt_b_dR","",mptVars.data());
 TNtuple *nt_mpt_boosted_b_dR=new TNtuple("nt_mpt_boosted_b_dR","",mptVars.data());
 TNtuple *nt_mp_b_dR=new TNtuple("nt_mp_b_dR","",mptVars.data());
 TNtuple *nt_mp_boosted_b_dR=new TNtuple("nt_mp_boosted_b_dR","",mptVars_dR.data());
 
 TNtuple *nt_mpt_dR=new TNtuple("nt_mpt_dR","",mptVars.data());
 TNtuple *nt_mpt_boosted_dR=new TNtuple("nt_mpt_boosted_dR","",mptVars.data());
 TNtuple *nt_mp_dR=new TNtuple("nt_mp_dR","",mptVars.data());
 TNtuple *nt_mp_boosted_dR=new TNtuple("nt_mp_boosted_dR","",mptVars_dR.data());
 ...
 for(int jentry=0;jentry<100;jentry++){
  ...
  float mpt_boosted_parts=0;
  float mp_boosted_parts=0;
  ...
  float mp_alpha_boosted_s[30];
  float mp_alpha_boosted_b[30];
  float mp_alpha_boosted[30];
  float mp_alpha_s[30];
  float mp_alpha_b[30];
  float mp_alpha[30];
  float mpt_alpha_boosted_s[30];
  float mpt_alpha_boosted_b[30];
  float mpt_alpha_boosted[30];
  ...
  float mp_alpha_boosted_parts[30];
  float mp_alpha_parts[30];
  float mpt_alpha_boosted_parts[30];
  ...
  float mp_dR_boosted_parts[30];
  float mp_dR_parts[30];
  float mpt_dR_boosted_parts[30];
  float mpt_dR_parts[30];
  ...
  float mp_dR_boosted_s[30];
  float mp_dR_boosted_b[30];
  float mp_dR_boosted[30];
  float mp_dR_s[30];
  float mp_dR_b[30];
  float mp_dR[30];
  float mpt_dR_boosted_s[30];
  float mpt_dR_boosted_b[30];
  float mpt_dR_boosted[30];
  float mpt_dR_s[30];
  float mpt_dR_b[30];
  float mpt_dR[30];
  ...
  for(int i=0;i<30;i++){
   ...
   mp_alpha_parts[i]=0;  
   mp_alpha_boosted_parts[i]=0;  
   mpt_alpha_parts[i]=0;  
   mpt_alpha_boosted_parts[i]=0;  
   mp_dR_parts[i]=0;  
   mp_dR_boosted_parts[i]=0;  
   mpt_dR_parts[i]=0;  
   mpt_dR_boosted_parts[i]=0;  
   mp_dR[i]=0;  
   mp_dR_s[i]=0;  
   mp_dR_b[i]=0;  
   mp_dR_boosted[i]=0;  
   ...
   mpt_dR_b[i]=0;  
   mpt_dR_boosted[i]=0;  
   mpt_dR_boosted_s[i]=0;  
   mpt_dR_boosted_b[i]=0;  
  }
  ...
  for(int itrk=0;itrk<ftrk->nParticle;itrk++){
   ...
   float trackselect=(ftrk->mtrkQual[itrk] && abs(ftrk->mtrkDxy1[itrk]/ftrk->mtrkDxyError1[itrk])<3.0 && abs(ftrk->mtrkDz1[itrk]/ftrk->mtrkDzError1[itrk])<3 && (ftrk->mtrkPtError[itrk]/ftrk->mtrkPt[itrk])<0.1);
   ...
   if(njet>1){
    ...
    if(trackselect)mpt_boosted_parts+=pt_boosted*cos(phi_boosted-phi1_boosted);
    alpha_boosted=vp_boosted.Angle(v1_boosted.Vect());
    if(trackselect) mp_boosted_parts+=vp_boosted.P()*cos(alpha_boosted);
   ...
   for(int i=0;i<30;i++){
    ...
    for(int i=0;i<30;i++){
      ...
      mpt_dR_boosted_t[i]=0;
        ...
        mpt_dR_boosted_parts[i]+=mpt_dR_boosted_t[i];
        mp_dR_t[i]=0;
        mp_dR_boosted_t[i]=0;
        ...
        mp_dR_boosted_parts[i]+=mp_dR_boosted_t[i];
	}
   } 
  ...
  for(int itrk=0;itrk<ftrk->nTrk;itrk++){
   ...
   if(njet>1){
    ...
    vp_boosted.Boost(0,0,-tanh(jetsrap_12)); 
	  ...
	  mpt_boosted_track=pt_boosted*cos(phi_boosted-phi1_boosted);
    if(trackselect)mpt_boosted_tracks+=pt_boosted*cos(phi_boosted-phi1_boosted);
    alpha_boosted=vp_boosted.Angle(v1_boosted.Vect());
    if(trackselect) mp_boosted_tracks+=vp_boosted.P()*cos(alpha_boosted);
  ...
  float smeared_pt=pt*(1+h_res->GetBinContent(h_res->FindBin(pt))*fgaus->GetRandom());
   ...
   for(int i=0;i<30;i++){
    ...
    for(int i=0;i<30;i++){
      ...
      mpt_dR_boosted_t[i]=0;
	    ...
	    if(((dR1 < dR_upperbound[i+1]) && dR1 >=dR_upperbound[i]) || ((dR2 < dR_upperbound[i+1]) && dR2 >=dR_upperbound[i])) mpt_dR_t[i] =pt*cos(phi -phi1);
      mpt_dR[i]+=mpt_dR_t[i];
      if(signal==1) mpt_dR_s[i]+=mpt_dR_t[i];
      else mpt_dR_b[i]+=mpt_dR_t[i];
	    if(((dR1 < dR_upperbound[i+1]) && dR1 >=dR_upperbound[i]) || ((dR2 < dR_upperbound[i+1]) && dR2 >=dR_upperbound[i])) mpt_dR_boosted_t[i] =pt *cos(phi -phi1);
      mpt_dR_boosted[i]+=mpt_dR_boosted_t[i];
      if(signal==1) mpt_dR_boosted_s[i]+=mpt_dR_boosted_t[i];
      else mpt_dR_boosted_b[i]+=mpt_dR_boosted_t[i];
      mp_dR_t[i]=0;
      mp_dR_boosted_t[i]=0;
	    if(((dR1_boosted < dR_upperbound[i+1]) && dR1_boosted >=dR_upperbound[i]) || ((dR2_boosted < dR_upperbound[i+1]) && dR2_boosted >=dR_upperbound[i])) mp_dR_t[i] =vp.P()*cos(alpha);
      mp_dR[i]+=mp_dR_t[i];
      if(signal==1) mp_dR_s[i]+=mp_dR_t[i];
      else mp_dR_b[i]+=mp_dR_t[i];
	    if(((dR1_boosted < dR_upperbound[i+1]) && dR1_boosted >=dR_upperbound[i]) || ((dR2_boosted < dR_upperbound[i+1]) && dR2_boosted>=dR_upperbound[i])) mp_dR_boosted_t[i] =vp_boosted.P()*cos(alpha_boosted);
      mp_dR_boosted[i]+=mp_dR_boosted_t[i];
      if(signal==1) mp_dR_boosted_s[i]+=mp_dR_boosted_t[i];
      else mp_dR_boosted_b[i]+=mp_dR_boosted_t[i];
	  }    
   }
   ...
   float pNRec =1;
   float entry[]={pt,eta,phi,rmin,pNRec,smeared_pt,cent,matchedpt,eff,trackselect,pt_boosted,p_boosted,eta_boosted,phi_boosted,cent,pt1,eta1,phi1,pt1_boosted,eta1_boosted,phi1_boosted,pt2,eta2,phi2,pt2_boosted,eta2_boosted,phi2_boosted,pt3,eta3,phi3,pt3_boosted,eta3_boosted,phi3_boosted,dphi,ptratio,jetspz,jetspt,jetseta,jetsrap,jetspz_12,jetspt_12,jetsrap_12,alpha,alpha_boosted,mpt_track,mpt_boosted_track,mpt_track_s,mpt_boosted_track_s,mpt_track_b,mpt_boosted_track_b};
  ...
  nt_mpt_boosted_dR->Fill(mpt_dR_boosted);
  nt_mp_dR->Fill(mp_dR);
  nt_mp_boosted_dR->Fill(mp_dR_boosted);
  
  nt_mpt_s_dR->Fill(mpt_dR_s);
  nt_mpt_boosted_s_dR->Fill(mpt_dR_boosted_s);
  nt_mp_s_dR->Fill(mp_dR_s);
  nt_mp_boosted_s_dR->Fill(mp_dR_boosted_s);
  
  nt_mpt_b_dR->Fill(mpt_dR_b);
  nt_mpt_boosted_b_dR->Fill(mpt_dR_boosted_b);
  nt_mp_b_dR->Fill(mp_dR_b);
  nt_mp_boosted_b_dR->Fill(mp_dR_boosted_b);
 
  nt_mpt_parts->Fill(mpt_alpha_parts);
  nt_mpt_boosted_parts->Fill(mpt_alpha_boosted_parts);
  nt_mp_parts->Fill(mp_alpha_parts);
  nt_mp_boosted_parts->Fill(mp_alpha_boosted_parts);
   
  nt_mpt_parts_dR->Fill(mpt_dR_parts);
  nt_mpt_boosted_parts_dR->Fill(mpt_dR_boosted_parts);
  nt_mp_parts_dR->Fill(mp_dR_parts);
  nt_mp_boosted_parts_dR->Fill(mp_dR_boosted_parts);
 ...
 nt_jet->Write();
  ...
  nt_mp_boosted_b->Write();
   ...
   nt_mpt_dR->Write();
  nt_mpt_boosted_dR->Write();
  nt_mp_dR->Write();
  nt_mp_boosted_dR->Write();
  
  nt_mpt_s_dR->Write();
  nt_mpt_boosted_s_dR->Write();
  nt_mp_s_dR->Write();
  nt_mp_boosted_s_dR->Write();
  
  nt_mpt_b_dR->Write();
  nt_mpt_boosted_b_dR->Write();
  nt_mp_b_dR->Write();
  nt_mp_boosted_b_dR->Write();
 
  nt_mpt_parts->Write();
  nt_mpt_boosted_parts->Write();
  nt_mp_parts->Write();
  nt_mp_boosted_parts->Write();
  
  nt_mpt_parts_dR->Write();
  nt_mpt_boosted_parts_dR->Write();
  nt_mp_parts_dR->Write();
  nt_mp_boosted_parts_dR->Write();
